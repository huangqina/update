...
char passwd_lb[]="123456\n"; 
char passwd_ai[]="123456\n"; 
char passwd_AIdisk[]="123123\n";
...
int mount(string disk,string filename) //mount the encrypted disk on server
{
	...
	while(loop)
	{
		...
		{
			case 1:
				write(fd, passwd_ai, sizeof(passwd_ai) - 1);
				break;
			case 2:
			...
			case 4:
				...
				break;
			case 5:
				write(fd, passwd_AIdisk, sizeof(passwd_AIdisk) - 1);
				break;
			case 6:
				write(fd, "\r\n", 2);
				break;
